...
Ext.define('517Employee.view.bill.restaurant.billCenter.Toolbar', {
    extend: 'Ext.panel.Panel',
    requires: [
    ],

    xtype: 'employee-bill-restaurant-billCenter-toolbar',
    title: '517 Employee Bill Service : Restaurant Bill',
    ...
    items:[
        {
            ...
            items:[
                ...
                },
                {
                    ...
                    items: [
                        ...
                        {
                            xtype:'combobox',
                            store:Ext.create( '517Employee.store.bill.restaurant.billCenter.RestaurantBillingCycle' ),
                            name:'restaurantBillingCycle',
                            displayField: 'name',
                            editable:false,
                            valueField: 'periods',
                            width:160,
                ...
                // Search
                {
                    ...
                    setGenerateInfo:function( name , storeId ) {
                        var me = this;
                        //me.items.items[ 1 ].setValue( name );
                        me.items.items[ 3 ].setValue( storeId );
                    }
                },
                // New Bill
                {
                    ...
                    items:[
                        {
                            ...
                            setGenerateInfo:function( name , storeId ) {
                                var me = this;
                                me.items.items[ 1 ]. items.items[ 7 ].setValue( name );
                                me.items.items[ 1 ]. items.items[ 8 ].setValue( storeId );
                            },
            ...
            addBillInformation:function( restaurant ) {
                var me = this;
                this.add( this.createBillContainer( restaurant ) );
            },
            createBillContainer:function( restaurant ) {
            ...
            doOperation:function() {
                Ext.getCmp( 'Employee-Bill-Restaurant-BillCenter-BillList').refreshView();
            },
    ...
    setDocumentNo:function() {
        ...
        var time_string = 'R' + time_string;
        this.items.items[ 0 ].items.items[ 3 ].items.items[ 0 ].setDocumentNo( time_string );
    },
    setGenerateInfo:function( storeName , storeId ) {
        this.items.items[ 0 ].items.items[ 2 ].setGenerateInfo( storeName , storeId );
        this.items.items[ 0 ].items.items[ 3 ].items.items[ 0 ].setGenerateInfo( storeName , storeId );
    },
    ...
    updateSearchParams:function( params , jsonData ) {
        ...
        if ( me.getCurrentType() == 'Search' ) {
            ...
            var storeId = me.getFieldItems( 'storeIdSearch' );
            if ( ! documentNo ) {
            ...
            var type1 = me.getFieldItems( 'type1' );
            var type2 = me.getFieldItems( 'type2' );
            var type3 = me.getFieldItems( 'type3' );
            var storeId = me.getFieldItems( 'storeId' );

            if ( typeof documentNo != 'undefined' && typeof adjustment != 'undefined' && typeof type1 != 'undefined' &&
                typeof type2 != 'undefined' && typeof type3 != 'undefined' && typeof storeId != 'undefined' && typeof adjustmentComment != 'undefined') {
                ...
                params.type1 = parseFloat( type1 ); jsonData.type1 = parseFloat( type1 );
                params.type2 = parseFloat( type2 ); jsonData.type2 = parseFloat( type2 );
                params.type3 = parseFloat( type3 ); jsonData.type3 = parseFloat( type3 );
                params.storeId = storeId; jsonData.storeId = storeId;
            }
            else {
                flag = false;
            }
