...
Ext.define( '517Employee.view.restaurant.information.restaurant.businessHour.BusinessHourController', {
    ...
    NewBusinessHour:function( button , clickEvent ) {
        ...
        console.log( 'asd' );
        if ( Ext.getCmp( 'Employee-Restaurant-Information-Restaurant' ).newRestaurant == false && Ext.getCmp( 'Employee-Restaurant-Dish-List' ).getSelectionModel().hasSelection() == false ) {
