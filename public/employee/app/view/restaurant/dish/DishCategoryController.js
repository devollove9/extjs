...
Ext.define( '517Employee.view.restaurant.dish.DishCategoryController' , {
    ...
    NewCategory:function( grid , rowIdx , columnIdx , button_icon , click_event , record_line , tr ) {
    ...
    EditCategory:function( grid , rowIdx , columnIdx , button_icon , click_event , record_line , tr ) {
        ...
        if ( Ext.getCmp( 'Employee-Restaurant-Dish-Category' ).gridEditing == true ) {
            ...
            if ( record.data.information ) {
                if ( record.data.information.businessHour ) {
                    ...
                    categoryBusinessHourStore.add( default_businessHour );
                }
                var rangeIdx = 999;
                                        ...
                                        Ext.Msg.show({
                                            ...
                                            fn: function(btn,text){
                                                if ( btn == 'yes' ) {
                                                    ...
                                                    var category_info = new Object();
                                                    category_info.information = new Object();

                                                    category_info.information.businessHour=[];
                                                    categoryBusinessHourStore.each( function( record , idx ) {
                                                        ...
                                                        category_info.information.businessHour.push( new_businessHour );
                                                    })
                                                    //category_info.information.rangeIndex1 = rangeIndex1;
                                                    category_info.logo = record.data.logo;
                                                    category_info.name = name;
                                                    category_info.nameEn = nameEn;
                                                    category_info.regionId = record.data.regionId;
                                                    category_info.categoryId = record.data.categoryId;
                                                    //category_info.sales = record.data.sales;
                                                    category_info.storeId = record.data.storeId;
                                                    category_info.information.disabled = disabled;

                                                    var result_category = JSON.stringify( category_info );
                                                    cur_window.setLoading(true);
                                                    Ext.Ajax.request({
                                                        url: '/employee/restaurant/put_category', // you can fix a parameter like this : url?action=anAction1
                                                        method: 'POST',
                                                        params: {
                                                            method: 'update_category',
                                                            category_info: result_category
                                                        },
                                                        success: function(result, request) {
                                                            var obj = Ext.decode(result.responseText);
                                                            if ( obj.categories.errorCode ) {
                                                                Ext.Msg.alert( obj.categories.errorCode.toString() ,'Error occured , contact technique support.');
                                                                ...
                                                                cur_window.close();
                                                                Ext.getCmp( 'Employee-Restaurant-Dish-Category' ).refreshGrid();
                                                            }
                                                        },
                                        ...
                                        Ext.Msg.show({
                                            ...
                                            fn: function(btn,text){
                                                if ( btn == 'yes' ) {
                                                    ...
                                                    category_info.name = name;
                                                    category_info.nameEn = nameEn;
                                                    category_info.regionId = record.regionId;
                                                    category_info.storeId = record.storeId;
