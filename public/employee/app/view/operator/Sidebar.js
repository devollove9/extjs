Ext.define('517Employee.view.operator.Sidebar', {
    extend: 'Ext.panel.Panel',
    xtype: 'employee-operator-sidebar',
    requires: [
        '517Employee.view.operator.SidebarController'
    ],
    title: 'OPERATOR',
    width:150,
    split: false,
    collapsible: true,
    controller:'employee-operator-sidebar',
    layout: { type: 'border' },
    ...
    dockedItems: [   
        {
            ...
            items: [
                ...
                },/*
                {
                    ...
                    id:'admin-sidebar-operator-management',
                    scale: 'medium',
