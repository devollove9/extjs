...
Ext.define('517Employee.view.order.orderhistory.OrderHistoryOrderList', {
    extend: 'Ext.grid.Panel',
    controller:'employee-order-orderHistory-orderList',
    requires: [
        '517Employee.view.order.orderhistory.OrderHistoryOrderListController'
    ],   
